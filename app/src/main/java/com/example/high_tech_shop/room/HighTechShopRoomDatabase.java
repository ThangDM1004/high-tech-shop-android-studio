...
@Database(entities = {Cart.class, Product.class, User.class, Order.class, OrderItem.class, Category.class, CartItem.class, ProductSubImage.class, UserAddress.class, Payment.class}, version = 1)
